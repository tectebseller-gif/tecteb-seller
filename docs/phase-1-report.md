...
| فایل | SHA-256 |
|---|---|
| `dist/tecteb-marketplace-core-0.1.0-alpha.2.zip` | `eb6bb3abba8480c21fcc552b47bcda100758de6d97670b67f4e8dc5b1aee2ce9` |
...
| ۷ | **`eb6bb3ab…ee2ce9`** | نسخه `0.1.0-alpha.2`: همان بازطراحی + اصلاح دکمه اصلیِ لینکی + نام‌گذاری نسخه‌دار بسته | **بسته فعلی** |

هش کامل بسته فعلی:
`eb6bb3abba8480c21fcc552b47bcda100758de6d97670b67f4e8dc5b1aee2ce9`
نام فایل: `tecteb-marketplace-core-0.1.0-alpha.2.zip`
