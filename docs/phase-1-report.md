...
| ۹ | **`79df5ff6…8b4c100d`** | نسخه `0.1.0-alpha.4`: مقدار پیام‌های خطا پس از redirect، مدارک بیرون از ریشه‌های وب (ADR-007)، و اصلاح همان نقص بسته‌بندی | **بسته فعلی** |

هش کامل بسته فعلی:
`79df5ff6801ce092316f3940a8401a14bb79bcce41f53e8ee0fbf7ba8b4c100d`
نام فایل: `tecteb-marketplace-core-0.1.0-alpha.4.zip`
