...
| ۸ | `8a838e3c…5a68a4` | نسخه `0.1.0-alpha.3`: **بخش فروشندگان** (درخواست، مدارک پویا، بررسی مدیر، پیشخوان `/vendor/`) | تحویل شد — و یک نقص بسته‌بندی داشت: `assets/vendor/tmc-vendor.css` داخلش نبود، پس ناحیه فروشنده بدون استایل بالا می‌آمد |
