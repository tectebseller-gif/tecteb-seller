...
| فایل | SHA-256 |
|---|---|
| `dist/tecteb-marketplace-core.zip` | `12773052b3f575eb1a45278b79b5987ed04c9e190206f26eb496e622d9035b20` |
...
| ۶ | **`12773052…035b20`** | بازطراحی چهار صفحه و اصلاح چیدمان (بند ۵) | **بسته فعلی** |

هش کامل بسته فعلی:
`12773052b3f575eb1a45278b79b5987ed04c9e190206f26eb496e622d9035b20`

> جدول گیت‌ها در بند ۳٫۲ **روی بسته ۵** اجرا شده است. روی بسته ۶، گیت‌های
> G-01 تا G-05 و G-08 و G-09 دوباره اجرا و قبول شدند (PHP 8.1.32 روی CLI، وب و
> WP-CLI — `acceptance/gates-12773052/`). **G-06 و G-07 (حالت‌های HPOS) روی
> بسته ۶ دوباره اجرا نشدند**؛ اسکریپت `tools/acceptance-gates.sh` آن دو را
> ندارد و تغییرهای این دور فقط لایه نمایش‌اند. وضعیتشان: نتیجه بسته ۵.
...
| کدام بسته، روی چه محیطی | **نامعلوم برای این جلسه**: هش بسته نصب‌شده، نسخه PHP و WordPress آن سایت، پوسته و افزونه‌های فعالش گزارش نشده‌اند |
...
| گیت‌های پذیرش روی WordPress واقعی | `bash tools/acceptance-gates.sh /home/user/php-src/sapi/cli/php …` | **G-01…G-05، G-08، G-09 قبول** با PHP **8.1.32** روی CLI و وب | `acceptance/gates-12773052/` |
...
- **G-06 و G-07 (HPOS) روی بسته ۶**: اجرا نشدند — بند ۴٫۱.
