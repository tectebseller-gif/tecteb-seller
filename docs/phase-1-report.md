...
| ۱۱ | **`dd8e364f…c622a385`** | نسخه `0.1.0-alpha.6`: **بخش محصولات** (مالکیت، تأیید انتشار، نسخهٔ پیشنهادی، موجودی، تصویر، فیلدهای پویای دسته، CSV)، تعلیق و بازگردانی فروشنده، موتور کمیسیون و دفترکل، و دروازهٔ عملیات سفارش (`docs/phase-4-products.md`) | **بسته فعلی** |

هش کامل بسته فعلی:
`dd8e364fec5a9cd71e1e3ac8e2ce4afb0d7a39de05c98a8f72117f8dc622a385`
نام فایل: `tecteb-marketplace-core-0.1.0-alpha.6.zip`
