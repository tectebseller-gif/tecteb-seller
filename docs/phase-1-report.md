...
| ۱۰ | **`69e8292f…1ded465c`** | نسخه `0.1.0-alpha.5`: تنظیمات فروشگاه، پرسنل و نقش‌ها، دعوت و دسترسی‌ها (`docs/phase-3-vendor-completion.md`)، و اصلاح تشخیص محل مدارک در نصب تو‌در‌تو | **بسته فعلی** |

هش کامل بسته فعلی:
`69e8292f5f7ab55fdda612fba407f338757c448347c5e60b42d774bc1ded465c`
نام فایل: `tecteb-marketplace-core-0.1.0-alpha.5.zip`
