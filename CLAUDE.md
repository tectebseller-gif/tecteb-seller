...
## محدوده فعلی: فاز ۱ + فروشندگان + محصولات + ووکامرس و سفارش + تسویه + ارسال جزئی، مرجوعی، کوپن/B2B/تیکت و مهاجرت آزمایشی دکان + نظر و امتیاز و نمودار + صف، API و رویداد، ممیزی و تجربهٔ فرم + قفل خوش‌بینانه و مهاجرت مشتق‌شده + **انتقال از دکان، اتصال به قالب و سطح عمومی فروشگاه** + **آینهٔ قابل‌مرور و مسیر سفارش روی نصب تمیز** + **داشبورد بررسی مدیر و مالکیت فیلد در ووکامرس** + **مقدار خالی و حذف تصویر اصلی** + **بررسی یکپارچه با مبنای تأییدشده**
